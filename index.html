...
<body>
  ...
  <div class="grid1">
    ...
    Lorem ipsum dolor sit amet,
        consectetur adipiscing elit. Nunc non
        diam erat. In fringilla massa ut nis
        ullamcorper
    ...
    <div class="container2">
        <div><h2><img class="logo2" src="../../pic/logo.png">Lorum ipsum dolor</h2><br>

        Lorem ipsum dolor sit amet,<br>
        consectetur adipiscing elit. Nunc non<br>
        diam erat. In fringilla massa ut nisi<br>
        ullamcorper.</div>
   ...
   <div><h2><img  class="logo2" src="../../pic/logo.png">Lorum ipsum dolor</h2><br>
    ...
    <div class="item2"><img class="foto2" src="../../pic/290x180.gif">Verder lezen klik hier 	&rarr;</div>
    <div class="item2"><img class="foto2" src="../../pic/290x180.gif">Verder lezen klik hier 	&rarr; </div>
    <div class="item2"><img class="foto2" src="../../pic/290x180.gif">Verder lezen klik hier 	&rarr; </div>
    </div>
    ...
    <div><img class="foto4" src="../../pic/whitepowerr.png"></div>    
    <div class="text"><h2>Lorum ipsum dolor</h2><br>

        Lorem ipsum dolor sit amet,
        consectetur adipiscing elit. Nunc non<br>
        diam erat. In fringilla massa ut nisi
        ullamcorper.</div> 
    
    </div>
    <div class="container5">
    <div><img class="foto4" src="../../pic//green%20power.png"></div>    
    <div class="text" ><h2>Lorum ipsum dolor</h2><br>
